...
const LoginSeller = () => {
  ...
  return (
    <div className="auth-container">
      {/* Background Orbs */}
      <div style={{ position: 'absolute', top: '10%', left: '10%', width: '300px', height: '300px', background: 'rgba(56, 189, 248, 0.05)', borderRadius: '50%', filter: 'blur(80px)', zIndex: 0 }}></div>
      ...
      <div className="auth-box animate-up">
        ...
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input 
              ...
              required 
              placeholder="business@eaglechoice.com" 
            />
          </div>
          <div className="form-group">
        ...
        <div style={{ marginTop: '2.5rem', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--auth-muted)', fontSize: '0.95rem' }}>
            Want to start selling? <Link to="/register" style={{ color: 'var(--primary)', fontWeight: 700, textDecoration: 'none' }}>Register your business</Link>
          </p>
          <div style={{ height: '1px', background: 'rgba(255,255,255,0.05)', margin: '1.5rem 0' }}></div>
          <p style={{ fontSize: '0.9rem' }}>
            <Link to="/login/buyer" style={{ color: 'var(--auth-muted)', textDecoration: 'none', fontWeight: 500, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
              Login as a customer <ArrowRight size={14} />
            </Link>
          </p>
        </div>
      </div>
